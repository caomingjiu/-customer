<template>
  <div>
    ...
    />
    <subject-model ref="modalForm" @getAll="getAll"></subject-model>
  </div>
</template>
<script>
const API = require("../../request/api.js");
import subjectModel from "./modules/subjectModel.vue";
const columns = [
  {
    title: "学课名称",
...
export default {
  ...
  methods: {
    ...
    handleAddClass() {
      this.$refs.modalForm.title = "添加课程信息";
    ...
    handleEdit(record) {
      ...
      this.$refs.modalForm.title = "修改课程信息";
      this.$refs.modalForm.visible = true;
    ...
    async selectSys() {
      this.url = this.GLOBAL.baseUrl + "/subject/page";
      this.data = {
